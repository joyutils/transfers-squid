module.exports = class Data1712914505886 {
    name = 'Data1712914505886'

    async up(db) {
        await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "block_hash" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_hash" text, "amount" numeric NOT NULL, "fee" numeric NOT NULL, "type" text NOT NULL, "remark" text, "vesting_duration_blocks" numeric, "from_id" character varying, "to_id" character varying, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE INDEX "IDX_c1baf61f210786bd446b6d5a0a" ON "transfer" ("type") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_c1baf61f210786bd446b6d5a0a"`)
